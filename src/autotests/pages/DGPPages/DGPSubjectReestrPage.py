...
class DGPSubjectReestrPage(BasePage):
    ...
    REQUEST_FOR_DOC_CSS = '#app > div.app-wrapper > div.uid-wrapper.flex-grow-1 > div > div.layout > div.content > div.short-info > div.short-info-statement > div > div.short-info-statement-button > button'
    REQUEST_FOR_DOC = 'Запросить ЕГРЮЛ'
    DOWNLOAD_BUTTON_CSS = '#app > div.app-wrapper > div.uid-wrapper.flex-grow-1 > div > div.layout > div.content > div.short-info > div.short-info-statement > div > div.download-files > button:nth-child(1)'
